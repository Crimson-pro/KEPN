...
generate_dict("data/dict_synonym.txt", "data/jieba.vocab", "data/tcnp.dev.src", "data/dev_paraphrased_pair.txt")
# generate_dict("data/dict_synonym.txt", "data/jieba.vocab", "data/tcnp.train.src", "data/train_paraphrased_pair.txt")
# generate_dict("data/dict_synonym.txt", "data/jieba.vocab", "data/tcnp.test.src", "data/test_paraphrased_pair.txt")
